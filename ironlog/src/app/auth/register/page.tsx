...
export default function RegisterPage() {
  ...
  // Redirect to wizard — /auth/register kept as fallback only
    ...
    <>
      ...
      <div className="page" style={{ paddingTop: 32 }}>
        <div className="col" style={{ alignItems: "center", marginBottom: 32 }}>
          ...
          <h1 className="t-title" style={{ marginTop: 16 }}>Join the leaderboard</h1>
          <p className="muted" style={{ fontSize: 15, marginTop: 4 }}>
            Track your progress. Compete with friends.
          </p>
        </div>

        <form onSubmit={handleRegister} className="col gap-sm">
          <input
            className="input"
            type="text"
